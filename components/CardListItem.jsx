...
const CardListItem = ({ cardData }) => {
    ...
    return (
        <div id='CardListItem' className='w-full md:h-screen md:mt-6 flex flex-col items-center py-2' style={{ height: 'fit-content' }}>
            <div className='max-w-[1240px] m-auto md:grid grid-cols-2 gap-8 '>
                <div className='col-span-2'>
                    ...
                    <div className="container mx-auto">
                        ...
                        {cardData.slice(0, visibleCards).map((data, idx) => (
            ...
            <button type="button"  onClick={handleLoadMore} className="md:mt-6 mt-2 md:w-56 w-auto text-white bg-pink-600 hover:bg-pink-700 font-medium rounded-full text-sm px-5 py-2.5 md:mb-2">Load More</button>
        </div>
    );
};
